...
% decrease margins on all sides to 1 inch
% \usepackage{fullpage}

% set margin values for top, bottom, left, right.
% set paperwidth and paperheight values to resize the document
...
\begin{document}
  ...
  % H (here (float)) h (here) t (top) b (bottom)
  \begin{figure}[H]
    \centering
